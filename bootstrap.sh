...
mkdir /tmp/.tordata
 for userno in $(seq 1 $TORCOUNT); do screen -dmS tor$userno /bin/ash -c '(echo "WarnUnsafeSocks 0";echo "WarnPlaintextPorts 1";echo "Log warn-err stderr";echo "DataDirectory /tmp/.tordata/tor"'$userno';echo "ControlPort 2000'$userno'";echo "SOCKSPort 1000'$userno'";echo "HashedControlPassword '$pswhash'")|tor -f /dev/stdin';done
linecnt=0
conncnt=0
